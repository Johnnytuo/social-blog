...
from socialnetwork.forms import LoginForm, RegisterForm,EditForm,ProfileForm,PostForm,CommentForm
...
def refresh_global_action(request):
    ...
    try:
        ...
        if not 'last_refresh' in request.GET or not request.GET['last_refresh']:
